...
public class Main {
	...
	public static void main(String[] args) {
		...
		Administrador admin1 = new Administrador(2, "Rafael Santos", "rafael_santos@mail.com", "12345678", perfil_admin1);
		...
		if(cadastro.equals("S")) {
			...
			Usuario user1 = new Usuario(1, nome, email, senha, perfil_user1);
			...
			Usuario user2 = new Usuario(1, "Giovanna Nogueira", "giovanna.nogueira@email.com", "giovanna1234", perfil_user2);
			...
			//Criando novos pedidos para user1 e user2
